...
export function AboutSection() {
  ...
  return (
    <section id="about" className="mx-auto w-full max-w-5xl px-6 py-24">
      ...
      <Stagger className="mt-12 grid gap-px overflow-hidden rounded-xl border border-ink-border bg-ink-border lg:grid-cols-3">
        <StaggerItem className="bg-ink-surface p-8 lg:col-span-2">
        ...
        <StaggerItem className="flex flex-col justify-between bg-ink-surface p-8">
        ...
        {t.about.tiles.map((tile) => (
          <StaggerItem key={tile.title} className="bg-ink-surface p-8">
